...
class AuctionBidPayment extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        if (count($payment->getShippingCity())) {
         ...
         if ($this->user_type == 'user') {
            ...
            $template = Template::where('slug','=','bidder_paid_bidding_amount')->first();
            ...
            $template = Template::where('slug','=','bidder_paid_bidding_amount_to_admin')->first();
