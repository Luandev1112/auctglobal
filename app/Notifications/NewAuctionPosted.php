...
class NewAuctionPosted extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
       /* return (new MailMessage)
          ...
          $template = Template::where('slug','=','new_auction_posted')->first();
    ...
    public function toDatabase($notifiable)
    {
         if ($this->user_type=='seller') {
               ...
               return [
                'title' => 'New Auction Posted by Admin',
                'description' =>  ' Admin has been posted an auction '.$this->auction->title,
                ...
                return [
                'title' => 'New Auction Posted by Seller ',
                'description' =>  ' Seller '.$this->seller_name.' has been posted an auction '.$this->auction->title,
                'url' => URL_AUCTIONS_VIEW.$this->auction->slug,
                'image' => getAuctionImage($this->auction->image)
            ];
        }
