...
<?php 
 ...
 <!--RECENT BUYERS SECTION-->
    <?php if(count($recent_buyers)): ?>
    <section class="au-similar-products">
        <div class="container-fluid">
            <div class="row">
              
              <div class="col-lg-12 col-md-12 col-sm-12 au-deals">
                <h2 class="text-center"> <?php echo e(getPhrase('recent_buyers')); ?></h2> 
              </div>
                    
               <div class="screenshot-similar-product">

                <?php $__currentLoopData = $recent_buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
