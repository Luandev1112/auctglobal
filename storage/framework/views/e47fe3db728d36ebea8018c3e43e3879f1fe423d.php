...
<?php $__env->startSection('content'); ?>
    <h3 class="page-title"> <?php echo e(getPhrase('questions')); ?> </h3>
        ...
        <div class="panel-heading">
           <?php echo e(getPhrase('list')); ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq_question_create')): ?>
                <a href="<?php echo e(URL_FAQ_QUESTIONS_ADD); ?>" class="btn btn-success btn-add pull-right"><?php echo e(getPhrase('add_new')); ?></a>
            <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $faq_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq_question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php $i++;?>
                            <tr data-entry-id="<?php echo e($faq_question->id); ?>">
                                ...
                                <td field-key='status'><?php echo e($faq_question->status); ?></td>
                                                                <td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq_question_view')): ?>
