    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('state_create')): ?>
                <a href="<?php echo e(URL_STATES_ADD); ?>" class="btn btn-success btn-add pull-right"> <?php echo e(getPhrase('add_new')); ?> </a>
            <?php endif; ?>
                         ...
                         <?php $i++;?>
                            <tr data-entry-id="<?php echo e($state->id); ?>">
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(URL_STATES_VIEW); ?>/<?php echo e($state->slug); ?>" class="btn btn-xs btn-primary"> <?php echo e(getPhrase('view')); ?> </a>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('state_edit')): ?>
                                    <a href="<?php echo e(URL_STATES_EDIT); ?>/<?php echo e($state->slug); ?>" class="btn btn-xs btn-info"> <?php echo e(getPhrase('edit')); ?> </a>
                                    <?php endif; ?>


                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('state_delete')): ?>
                                    <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="deleteRecord('<?php echo e($state->id); ?>')"> <?php echo e(getPhrase('delete')); ?></a>
                                    <?php endif; ?>
                                </td>
