...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					<a href="{{DOWNLOAD_LINK_CATEGORIES_IMPORT_EXCEL}}" class="btn btn-info">{{getPhrase('download_template')}}
					</a>
					@if($download_link)
					...
					<?php $button_name = getPhrase('upload'); ?>
						...
						{!! Form::open(array('url' => URL_CATEGORIES_IMPORT, 'method' => 'POST', 'novalidate'=>'','name'=>'formUsers ', 'files'=>'true')) !!}
