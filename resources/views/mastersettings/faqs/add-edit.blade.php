				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					@if ($record)
					 <?php $button_name = getPhrase('update'); ?>
						{{ Form::model($record, 
						array('url' => URL_FAQS_EDIT.'/'. $record->slug, 
						'method'=>'patch', 'name'=>'formBanks','novalidate'=>'')) }}

						
					@else
						{!! Form::open(array('url' => URL_FAQS_ADD, 'method' => 'POST', 'name'=>'formBanks', 'novalidate'=>'')) !!}
					@endif

					 @include('mastersettings.faqs.form_elements', 
