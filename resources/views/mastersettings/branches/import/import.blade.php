				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><a href="{{URL_BRANCHES}}">{{ getPhrase('branches')}}</a> </li>
				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					@if(checkRole(getUserGrade(1))) 
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_BRANCHES}}" class="btn  btn-primary button" >{{ getPhrase('list')}}</a>
					...
					<a href="{{DOWNLOAD_LINK_BRANCHES_IMPORT_EXCEL}}" class="btn btn-info">{{getPhrase('download_template')}}
					</a>
					@if($download_link)
					...
					<?php $button_name = getPhrase('upload'); ?>
						...
						{!! Form::open(array('url' => URL_BRANCHES_IMPORT, 'method' => 'POST', 'novalidate'=>'','name'=>'formUsers ', 'files'=>'true')) !!}
