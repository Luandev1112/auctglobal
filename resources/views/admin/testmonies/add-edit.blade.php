     ...
     <div class="panel panel-default">
        ...
        <div class="panel-body form-auth-style" id="app">
        	...
        	<div class="row">
        		@if ($record)
				{{ Form::model($record, 
				array('url' => URL_TETSIMONIALS_EDIT.'/'.$record->id, 
				'method'=>'PATCH', 'name'=>'formValidate', 'novalidate'=>'')) }}
				@else
				{!! Form::open(array('url' => URL_TETSIMONIALS_ADD, 'method' => 'POST','name'=>'formValidate', 'novalidate'=>'')) !!}
				@endif

				@include('admin.testmonies.form_elements', array('record' => $record))
